...
| ------------------------ | -------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| [[Порождающие паттерны]] | [[Abstract Factory (абстрактная фабрика)]]         | Семейства порождаемых объектов                                                                                               |
|                          | [[Singleton (одиночка)]]                           | Единственный экземпляр объекта                                                                                               |
|                          | [[Prototype (прототип)]]                           | Класс, но основе которого создается объект                                                                                   |
|                          | [[Builder (строитель)]]                            | Способ создания объекта                                                                                                      |
|                          | [[Factory Method (фабричный метод)]]               | Подкласс создаваемого объекта                                                                                                |
| [[Структурные паттерны]] | [[Adapter (адаптер)]]                              | Интерфейс к объекту                                                                                                          |
|                          | [[Decorator (декоратор)]]                          | Обязанности объекта без порождения подкласса                                                                                 |
|                          | [[Proxy (заместитель)]]                            | Способ доступа к объекту, его местоположение                                                                                 |
|                          | [[Composite (компоновщик)]]                        | Структура и состав объекта                                                                                                   |
|                          | [[Bridge (мост)]]                                  | Реализация объекта                                                                                                           |
|                          | [[Flyweight (приспособленец)]]                     | Затраты на хранение объектов                                                                                                 |
|                          | [[Facade (фасад)]]                                 | Интерфейс к подсистеме                                                                                                       |
| [[Паттерны поведения]]   | [[Interpreter (интерпретатор)]]                    | Грамматика и интерпретация языка                                                                                             |
|                          | [[Iterator (итератор)]]                            | Способ перебора элементов агрегата                                                                                           |
|                          | [[Command (команда)]]                              | Время и способ выполнения запроса                                                                                            |
|                          | [[Observer (наблюдатель)]]                         | Множество объектов, зависящих от другого объекта; способ, которым зависимые объекты поддерживают себя в актуальном состоянии |
|                          | [[Visitor (посетитель)]]                           | Операции, которые могут применяться к объекту или объектам, не меняя класс                                                   |
|                          | [[Mediator (посредник)]]                           | Взаимодействующие объекты и механизм их совместной работы                                                                    |
|                          | [[State (состояние)]]                              | Состояние объекта                                                                                                            |
|                          | [[Strategy (стратегия)]]                           | Алгоритм                                                                                                                     |
|                          | [[Memento (хранитель)]]                            | Закрытая информация, хранящаяся вне объекта, и время ее сохранения                                                           |
|                          | [[Chain of Responsibility (цепочка обязанностей)]] | Объект, выполняющий запрос                                                                                                   |
|                          | [[Template Method (шаблонный метод)]]              | Шаги алгоритма                                                                                                               |

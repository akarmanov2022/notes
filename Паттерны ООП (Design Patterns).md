...
| ------------------------ | --------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| [[Порождающие паттерны]] | [[Порождающие паттерны#Abstract Factory (абстрактная фабрика)]]       | Семейства порождаемых объектов                                                                                               |
|                          | [[Порождающие паттерны#Singleton (одиночка)]]                         | Единственный экземпляр объекта                                                                                               |
|                          | [[Порождающие паттерны#Prototype (прототип)]]                         | Класс, но основе которого создается объект                                                                                   |
|                          | [[Порождающие паттерны#Builder (строитель)]]                          | Способ создания объекта                                                                                                      |
|                          | [[Порождающие паттерны#Factory Method (фабричный метод)]]             | Подкласс создаваемого объекта                                                                                                |
| [[Структурные паттерны]] | [[Структурные паттерны#Adapter (адаптер)]]                            | Интерфейс к объекту                                                                                                          |
|                          | [[Структурные паттерны#Decorator (декоратор)]]                        | Обязанности объекта без порождения подкласса                                                                                 |
|                          | [[Структурные паттерны#Proxy (заместитель)]]                          | Способ доступа к объекту, его местоположение                                                                                 |
|                          | [[Структурные паттерны#Composite (компоновщик)]]                      | Структура и состав объекта                                                                                                   |
|                          | [[Структурные паттерны#Bridge (мост)]]                                | Реализация объекта                                                                                                           |
|                          | [[Структурные паттерны#Flyweight (приспособленец)]]                   | Затраты на хранение объектов                                                                                                 |
|                          | [[Структурные паттерны#Facade (фасад)]]                               | Интерфейс к подсистеме                                                                                                       |
| [[Паттерны поведения]]   | [[Паттерны поведения#Interpreter (интерпретатор)]]                    | Грамматика и интерпретация языка                                                                                             |
|                          | [[Паттерны поведения#Iterator (итератор)]]                            | Способ перебора элементов агрегата                                                                                           |
|                          | [[Паттерны поведения#Command (команда)]]                              | Время и способ выполнения запроса                                                                                            |
|                          | [[Паттерны поведения#Observer (наблюдатель)]]                         | Множество объектов, зависящих от другого объекта; способ, которым зависимые объекты поддерживают себя в актуальном состоянии |
|                          | [[Паттерны поведения#Visitor (посетитель)]]                           | Операции, которые могут применяться к объекту или объектам, не меняя класс                                                   |
|                          | [[Паттерны поведения#Mediator (посредник)]]                           | Взаимодействующие объекты и механизм их совместной работы                                                                    |
|                          | [[Паттерны поведения#State (состояние)]]                              | Состояние объекта                                                                                                            |
|                          | [[Паттерны поведения#Strategy (стратегия)]]                           | Алгоритм                                                                                                                     |
|                          | [[Паттерны поведения#Memento (хранитель)]]                            | Закрытая информация, хранящаяся вне объекта, и время ее сохранения                                                           |
|                          | [[Паттерны поведения#Chain of Responsibility (цепочка обязанностей)]] | Объект, выполняющий запрос                                                                                                   |
|                          | [[Паттерны поведения#Template Method (шаблонный метод)]]              | Шаги алгоритма                                                                                                               |



# Каталог Паттернов Проектирования

### [[Порождающие паттерны#Abstract Factory (абстрактная фабрика)]]
...
### [[Порождающие паттерны#Builder (строитель)]]
...
### [[Порождающие паттерны#Prototype (прототип)]]
...
### [[Порождающие паттерны#Singleton (одиночка)]]
